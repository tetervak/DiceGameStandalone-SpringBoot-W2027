# Dice Game (Spring Boot)

The web application was developed as an example for a programming course. 
The example is intended for the beginning of a programming course, 
...
- `simplest-templates` branch is using simplistic CSS files
